...
import { ChangeSelectionTextMessage } from "@common/network/messages/ChangeSelectionTextMessage";
...
export namespace NetworkMessages {
  ...
  export const CHANGE_SELECTION_TEXT = registry.register(
    new ChangeSelectionTextMessage("change-selection-text")
  );
}
